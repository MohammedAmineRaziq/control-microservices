...
export class ChartComponent implements OnInit{
  index=1;
  customers=["Amine","Mohamed","Hassan"];
  colors=[{stroke :'rgba(0,255,0,1)',fill:'rgba(0,255,0,0.2)'},
  ...
  ngOnInit(): void {
    ...
    var stockEventSource=new EventSource("http://host.docker.internal:8086/analytics");
